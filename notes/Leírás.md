...
A két fa csúcsai Node objektumokból állnak. A map is ilyen objektumokat tárol. A Node osztály három adatmezőt tartalmaz: a csúcs kulcsát és két mutatót a gyerekcsúcsokra. A kulcs egy egész szám. Az egyik fa közvetlenül a heap-en tárolja a csúcsait, a másik egy vector segítségével folytonosan tárolja őket. A fák létrehozásuk után nem módosíthatók.
...
A tesztelés két paramétert fogad: tesztek száma (K) és a random generátor kezdőértéke (test_seed). A random generátor segítségével a data vector-ból egy véletlen kulcs megkeresése lefut a három adatszerkezetben, ezeknek a futási idejét a program kiírja/elmenti. 